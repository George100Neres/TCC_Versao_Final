...
export const CategoriaSchemaBase = z.object({
  id: z.uuid().optional(),
  nome: z.string().min(1, 'O nome deve ter ao menos 1 caractere').max(100, 'O nome deve ter no máximo 100 caracteres'),
...
export type CreateCategoriaDTO = z.infer<typeof CategoriaSchemaBase>
